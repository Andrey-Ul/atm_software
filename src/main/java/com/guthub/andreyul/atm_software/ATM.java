package com.guthub.andreyul.atm_software;
...
public class ATM {
    ...
    public static void main(String[] args) {
        ...
        // init Bank
        Bank theBank = new Bank("Bank of Halifax");

        // add a user, which also creates a savings account
        User aUser = theBank.addUser("Andrey", "Ulanov", "1234");
     ...
     * @param theUser   the logged-in User oblect
    ...
    /**
     * Process a fund withdraw from on account
    ...
    public static void showTransHistory(User theUser, Scanner sc) {
        ...
        // get account whose transaction history to look
        do {
